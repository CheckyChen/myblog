# Generated by Django 2.1.4 on 2018-12-23 10:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(null=True, upload_to='articla_img/%Y/%m/%d/', verbose_name='文章图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('linkurl', models.CharField(max_length=100, verbose_name='网址')),
            ],
            options={
                'verbose_name': '友情链接',
        ...
        migrations.AddField(
            model_name='article',
            name='tui',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='blog.Tui', verbose_name='推荐位'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
